...
def get_append_timestamp(append_timestamp):
    now = ''
    if append_timestamp:
...
class Component(CommonInterface):
    ...
    def run(self):
        ...
        pkey = get_private_key(params[KEY_PRIVATE_KEY])
    ...
    def _upload_file(self, input_file, sftp):
        ...
        now = get_append_timestamp(params.get(KEY_APPENDDATE))
        path = fix_path(params[KEY_REMOTE_PATH])
